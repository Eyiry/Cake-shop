<template>
    ...
    <v-app id="carrito">
        ...
        <v-btn rounded normal color="success" dark flat @click="compra()">Pagar</v-btn>
    </v-app>
    </body>
</template>
...
export default {
  ...
  mounted () {
    ...
    axios.post('https://g14bvnl3z8.execute-api.us-east-1.amazonaws.com/default/getcarrito', sale)
  ...
  methods: {
    ...
    compra: function () {       
          const sale = {
              'userFK':this.$cookies.get('mipk')
          }

          axios.post('https://g14bvnl3z8.execute-api.us-east-1.amazonaws.com/default/pagar', sale)
            .then(response => {
