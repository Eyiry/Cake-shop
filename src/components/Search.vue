<template>
    ...
    >
      ...
      >
        ...
        <div class="row">
            <div class="column" v-for="cake in cakes" :key="cake.a01375332_nomb_productos">
                <Cake :cake="cake" />
            </div>
        </div>
    </v-app>
...
export default {
  ...
  data () {
    return {
      ...
      search () {
        const article = {'cadena': this.que}
        axios.post('https://g14bvnl3z8.execute-api.us-east-1.amazonaws.com/default/busqueda', article)
...
/*Preguntar Como hacer para que los margenes queden iguales*/
.row {
    margin: 30px 10px;
}

/*No mover esto quita el margen del abajo*/
.row:after {
    content: "";
    display: table;
    clear: both;
